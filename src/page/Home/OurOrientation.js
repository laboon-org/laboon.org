                ...
                <div className="row no-gutters">
                  <div className="aboutus__right-1 col l-6 c-12 m-12 l0-6 ">
                    <div className="aboutus__card aboutus__card-mt col c-12">
                      <img src="https://storage.googleapis.com/laboon-img-storage/laboon/image-Home-OurOrientation/laboon_image-Home-OurOrientation_card1.webp" alt="" className="aboutus__card-img" />
                    ...
                    <div className="aboutus__card col c-12 m-12">
                      <img src="https://storage.googleapis.com/laboon-img-storage/laboon/image-Home-OurOrientation/laboon_image-Home-OurOrientation_card2.webp" alt="" className="aboutus__card-img" />
                      <div className="aboutus__card-infor">
                  ...
                  <div className="aboutus__right-2 col l-6 c-12 m-12 l0-6">
                    <div className="aboutus__card aboutus__card-mt col c-12">
                      <img src="https://storage.googleapis.com/laboon-img-storage/laboon/image-Home-OurOrientation/laboon_image-Home-OurOrientation_card3.webp" alt="" className="aboutus__card-img" />
                      <div className="aboutus__card-infor">
                    ...
                    <div className="aboutus__card col c-12 m-12">
                      ...
                      <img src="https://storage.googleapis.com/laboon-img-storage/laboon/image-Home-OurOrientation/laboon_image-Home-OurOrientation_card4.webp" alt="" className="aboutus__card-img" />
                      <div className="aboutus__card-infor">
                        <span>Synthe</span>
